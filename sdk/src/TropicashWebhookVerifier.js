/**
 * Tropicash SDK — webhook signature verifier (package build).
 *
 * Verifies the HMAC-SHA256 signatures produced by the Tropicash webhook layer:
 ...
 *
 * Packaged copy of lib/sdk/TropicashWebhookVerifier.js (Phase 12I).
 */
