    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 py-8 pb-16 sm:px-6 sm:py-10">
        ...
        <p className="mt-2 max-w-2xl text-sm leading-relaxed text-slate-600 sm:text-base">
          Version {LEGAL_DOC_VERSION} effective {LEGAL_EFFECTIVE_DATE}. Private Alpha policy set for wallet funding,
          transfers, withdrawals, identity verification, and compliance obligations.
        </p>
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-1">
          {LEGAL_DOCUMENTS.map((doc) => (
            ...
            >
              ...
              <span className="mt-3 inline-block text-sm font-semibold text-blue-700">Read policy →</span>
            </Link>
          ))}
        </div>
