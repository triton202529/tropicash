...
/** Risk review case audit actions (human review queue; best-effort via logAdminAuditEvent). */
export const RISK_CASE_AUDIT_ACTIONS = {
  created: "risk_case_created",
  duplicateNoteAdded: "risk_case_duplicate_note_added",
  statusChanged: "risk_case_status_changed",
  assigned: "risk_case_assigned",
  assignment: "risk_case_assignment",
  noteAdded: "risk_case_note_added",
  recommendationGenerated: "risk_case_recommendation_generated",
  repeatSubjectDetected: "risk_case_repeat_subject_detected",
  resolution: "risk_case_resolution",
};

/**
 * Severity for risk review case audit rows from case priority.
 * @param {string} priority
 */
export function auditSeverityFromCasePriority(priority) {
