...
export const DEV_CONSOLE_ROUTES = [
  ...
  {
    path: "/dev-console/workspace",
    label: "Workspace",
    icon: "🏠",
    description:
      "Phase 7A + 7B developer operating center — identity, persona context, milestones, smart recommendations, and readiness (static seeds only).",
  },
  {
  ...
  {
    path: "/dev-console/credential-lifecycle",
    label: "Credential Lifecycle",
    icon: "🪪",
    description:
      "Phase 8A + 8B sandbox credential lifecycle and metadata-only credential governance — placeholder statuses, visibility rules, review modeling (no keys, secrets, or auth).",
  },
  {
  ...
  {
    path: "/dev-console/request-simulator",
    label: "Request Simulator",
    icon: "📨",
    description:
      "Phase 10A + 10B sandbox request flow, governance, and observability — credential placeholder, entitlement, auth/gateway/routing linkage, audit trail seeds, and response previews only; no endpoints, live traffic, or telemetry emitters.",
  },
  {
  ...
  {
    path: "/dev-console/product-access",
    label: "Product Access",
    icon: "🎫",
    description:
      "Phase 9A + 9B sandbox product access and governance — entitlement previews, visibility rules, capability mapping, and usage envelopes (metadata only — no endpoints or execution).",
  },
  {
  ...
  {
    path: "/dev-console/credentials",
    label: "API Credentials",
    icon: "🔑",
    description:
      "Phase 12A real API credential management — generate sandbox keys, rotate, and revoke. Secrets are shown once and stored only as SHA-256 hashes.",
  },
  {
    path: "/dev-console/usage",
    label: "API Usage",
    icon: "📈",
    description:
      "Phase 12C API usage logs and sandbox rate limits — request volume, recent activity, and per-key limits (100/hour, 1000/day).",
  },
  {
    ...
    icon: "🔔",
    description:
      "Phase 12D webhook endpoints — register HTTPS endpoints, rotate signing secrets, and send signed test deliveries (HMAC-SHA256).",
  },
  {
    path: "/dev-console/events",
    label: "Event Registry",
    icon: "📚",
    description:
      "Phase 12E developer event registry — the single source of truth for available and planned events across webhooks, APIs, and integrations.",
  },
  {
    path: "/dev-console/sdk",
    label: "SDK",
    icon: "📦",
    description:
      "Phase 12F official SDK foundation — client authentication, environment management, and HMAC-SHA256 webhook verification (architecture preview; package not published).",
  },
  {
    path: "/dev-console/wallet-api-readiness",
    label: "Wallet API Readiness",
    icon: "🧪",
    description:
      "Phase 12G wallet API readiness assessment — data classification, scope matrix, consent model, security findings, and tiered rollout blueprint (read-only; no APIs exposed).",
  },
  {
    path: "/dev-console/oauth-data-model",
    label: "OAuth Data Model",
    icon: "🔓",
    description:
      "Phase 12K OAuth consent data model — clients, consents, token (hash-only) and audit tables, scope catalog, and RLS rules (schema documentation only; no OAuth flow).",
  },
  {
    path: "/dev-console/oauth-clients",
    label: "OAuth Clients",
    icon: "🪪",
    description:
      "Phase 12L OAuth client registration — register clients, issue hash-only client secrets (shown once), validate redirect URIs, and rotate/disable clients (no tokens, consent, or authorization flow).",
  },
  {
    path: "/dev-console/oauth-testing",
    label: "OAuth Testing",
    icon: "🧪",
    description:
      "Phase 12T OAuth developer testing console — build authorization URLs, select scopes, and copy token/refresh/profile/introspection request examples (sandbox only; no tokens auto-issued, no wallet access).",
  },
  {
    path: "/dev-console/oauth-wallet-readiness",
    label: "OAuth Wallet Readiness",
    icon: "🛡️",
    description:
      "Phase 12X OAuth wallet readiness gate — evaluates whether GET /api/oauth/wallet can safely be built (assessment only; no wallet endpoint, no balances exposed).",
  },
  {
    path: "/dev-console/oauth-wallet-test",
    label: "OAuth Wallet Test",
    icon: "🔬",
    description:
      "Phase 13A OAuth wallet sandbox test harness — interactive E2E flow for authorization, token exchange, profile + wallet read, refresh, and revocation (sandbox only; no money movement).",
  },
  {
